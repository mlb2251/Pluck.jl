...
function def_constructors()
    ...
    define_type!(:Int3, Dict(:Int3 => Symbol[:bool, :bool, :bool]))
    define_type!(:Int2, Dict(:Int2 => Symbol[:bool, :bool]))
    define_type!(:Int1, Dict(:Int1 => Symbol[:bool]))
    ...
    @define perturb "list -> list" "(Y (λ rec xs -> (case xs of Nil => (if (flip 0.99) (Nil) (Cons (random_digit) (rec (Nil)))) | Cons => (λ hd tl -> (if (flip 0.99) (Cons hd (rec tl)) (if (flip 0.5) (rec tl) (Cons (random_digit) (rec (if (flip 0.5) xs tl)))))))))"
    ...
    @define "iff" "(λ a b -> (if a b (not b)))"
    @define "int4_eq" "(λ a b -> (case a of Int4 => (λ a1 a2 a3 a4 -> (case b of Int4 => (λ b1 b2 b3 b4 -> (and (iff a1 b1) (and (iff a2 b2) (and (iff a3 b3) (iff a4 b4)))))))))"
    @define "int3_eq" "(λ a b -> (case a of Int3 => (λ a1 a2 a3 -> (case b of Int3 => (λ b1 b2 b3 -> (and (iff a1 b1) (and (iff a2 b2) (iff a3 b3))))))))"
    @define "int2_eq" "(λ a b -> (case a of Int2 => (λ a1 a2 -> (case b of Int2 => (λ b1 b2 -> (and (iff a1 b1) (iff a2 b2)))))))"
    @define "int1_eq" "(λ a b -> (case a of Int1 => (λ a1 -> (case b of Int1 => (λ b1 -> (iff a1 b1))))))"
end
