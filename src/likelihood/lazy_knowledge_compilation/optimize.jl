...
# function optimize(exprs, η, init, n_steps; state = LazyKCStateDual())
...
#         # update metaparams
#         metaparam_vals = clamp.(metaparam_vals + η * log_true_prob_dual[2], 0.0, 1.0)
#         # update bdd weights
#         for (param, metaparam) in state.param2metaparam
#                 set_weight_dual(
#                 state.manager, 
...
#     return expDual(log_true_prob_dual), metaparam_vals
# end
